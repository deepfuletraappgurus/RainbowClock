...
const GroupTitle = ({ title }) => {
  return (
    <View style={styles.groupCommandTitle}>
      <Text style={styles.groupCommandText}>{title}</Text>
    </View>
  );
};
...
const TextInputCommand = ({ title, value, onChangeText }) => {
  return (
    <View style={styles.command}>
      <Text style={styles.cmdInfo}>{title}</Text>
      <TextInput
...
export default class ClockScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      borderColor: "black",
      borderAlpha: 1.0,
      faceBackgroundColor: "#rgb(0.0,0.0,0)",
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>React Native Analog Clock</Text>
        ...
        <ScrollView style={styles.commandsPanel}>
          {/* PROPERTIES */}
          <GroupTitle title={"GENERAL PROPERTIES"} />
          <TextInputCommand
            title={'manual set "hours"'}
            onChangeText={text =>
              this.setState({ hours: parseInt(text, 10) % 12 })
            }
          ...
          <TextInputCommand
            ...
            onChangeText={text =>
              this.setState({ minutes: parseInt(text, 10) % 60 })
            }
          ...
          <TextInputCommand
            ...
            onChangeText={text =>
              this.setState({ seconds: parseInt(text, 10) % 60 })
            }
          ...
          <GroupTitle title={"CLOCKS'S FACE CUSTOMIZATION"} />
          <SliderCommand
          ...
          />
          <SliderCommand
            title={`faceBackgroundAlpha (${(faceBackgroundAlpha + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ faceBackgroundAlpha: value })
            }
          />
          {/* HOURS HAND CUSTOMIZATION */}
          <GroupTitle title={"HOURS HAND CUSTOMIZATION"} />
          {/* hourHandColor */}
          <ColorCommand
            title={"hourHandColor"}
            value={hourHandColor}
          ...
          {/* hourHandOffsideLength */}
          <SliderCommand
            title={`hourHandOffsideLength (${(hourHandOffsideLength + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ hourHandOffsideLength: value })
            }
          />
          {/* MINUTES HAND CUSTOMIZATION */}
          <GroupTitle title={"MINUTES HAND CUSTOMIZATION"} />
          {/* minuteHandColor */}
          <ColorCommand
          ...
          <SliderCommand
            ...
            onValueChange={value =>
              this.setState({ minuteHandOffsideLength: value })
            }
          />
          {/* SECONDS HAND CUSTOMIZATION */}
          <GroupTitle title={"SECONDS HAND CUSTOMIZATION"} />
          {/* hourHandColor */}
          <ColorCommand
          ...
          <SliderCommand
            ...
            onValueChange={value =>
              this.setState({ secondHandOffsideLength: value })
            }
          />
          {/* HUB CUSTOMIZATION */}
          <GroupTitle title={"HUB CUSTOMIZATION"} />
          {/* hubColor */}
          <ColorCommand
            title={"hubColor"}
            value={hubColor}
          ...
          <GroupTitle title={"GRADUATIONS CUSTOMIZATION"} />
          {/* accentGraduationModulo */}
          <SliderCommand
            ...
            onValueChange={value =>
              this.setState({ accentGraduationModulo: value })
            }
          />
          {/* highGraduationLength */}
          <SliderCommand
            title={`highGraduationLength (${(highGraduationLength + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ highGraduationLength: value })
            }
          />
          {/* smallGraduationLength */}
          <SliderCommand
            title={`smallGraduationLength (${(smallGraduationLength + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ smallGraduationLength: value })
            }
          />
          {/* highGraduationWidth */}
          <SliderCommand
            title={`highGraduationWidth (${(highGraduationWidth + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ highGraduationWidth: value })
            }
          />
          {/* smallGraduationWidth */}
          <SliderCommand
            title={`smallGraduationWidth (${(smallGraduationWidth + "").slice(
              0,
              4
            )})`}
            ...
            onValueChange={value =>
              this.setState({ smallGraduationWidth: value })
            }
          />
        </ScrollView>
      </View>
