...
export default class ParentsSelectChildScreen extends BaseComponent {
  ...
  componentDidMount() {
    ...
    this.focusListener = this.props.navigation.addListener('didFocus', () => {
        this.callGetChild(); // Call the API when component gains focus
    });
  }
    ...
    return (
      <>
        <TouchableOpacity
          ...
          onPress={() => this.moveToParentHomeScreen(item)}>
        ...
        <TouchableOpacity
          ...
          <Image
            style={[styles.deleteIcon, {tintColor: 'black'}]}
            source={Images.bin}
          />
        </TouchableOpacity>
      </>
            ...
            <View style={[styles.container]}>
              <View style={styles.selectUserList}>
                {this.state.isLoading ? (
                  ...
                  <Text style={styles.waitText}>
                    {Constants.TEXT_NO_CHILD_ADDED_YET}
                  </Text>
                )}
              </View>
              <TouchableOpacity
                style={[styles.button, styles.buttonPrimary]}
                onPress={() => this.moveToAddChild()}>
                <Text style={styles.buttonText}>
                  {'Add a New Child'.toUpperCase()}
                </Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
