...
export default class PinScreen extends BaseComponent {
  ...
  isValidate = () => {
    ...
    var strConfirmPin =
      this.state.cpin1 + this.state.cpin2 + this.state.cpin3 + this.state.cpin4;
                        ...
                        <TextInput
                          ...
                          onKeyPress={e => {
                            if (e.nativeEvent.key == 'Backspace') {
                              ...
                              this.manageNextField(1, e.nativeEvent.key, '');
                            }
                          }}
                          onChangeText={e => {
                            if (Platform.OS != 'ios') {
                        ...
                        <TextInput
                          ...
                          onKeyPress={e => {
                            if (e.nativeEvent.key == 'Backspace') {
                              ...
                              this.manageNextField(2, e.nativeEvent.key, '');
                            }
                          }}
                          onChangeText={e => {
                            if (Platform.OS != 'ios') {
                        ...
                        <TextInput
                          ...
                          onKeyPress={e => {
                            if (e.nativeEvent.key == 'Backspace') {
                              ...
                              this.manageNextField(4, e.nativeEvent.key, '');
                            }
                          }}
                          onChangeText={e => {
                            if (Platform.OS != 'ios') {
