...
export default class AnalogClock extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      hour:((d.getHours() % this.props.hourFormate) / this.props.hourFormate) * 360 +90 +(d.getMinutes() * 6 + (d.getSeconds() * 6) / 60) / this.props.hourFormate,
    };
  }
  ...
  componentDidMount() {
    this.timer = setInterval(() => {
      ...
      this.setState({ hour:((d.getHours() % this.props.hourFormate) / this.props.hourFormate) * 360 +90 +(d.getMinutes() * 6 + (d.getSeconds() * 6) / 60) / this.props.hourFormate});
    }, 1000);
  }
    ...
    return (
      <View style={this.clockFrame()}>
        <View style={this.clockHolder()}>
          <View style={[this.hourHandStyles(),{transform: [{ rotate: this.state.hour + "deg" },{translateX: -(this.props.hourHandOffset +this.props.hourHandLength / 2)}]}]}/>
          {/* {this.state.hourFormate==12 && ( */}
          {this.props.hourFormate === 12 && <View style={[this.minuteHandStyles(),{transform: [{ rotate: this.state.min + "deg" },{translateY: -(this.props.minuteHandOffset +this.props.minuteHandLength / 2)}]}]}/>}
           {/* <View style={[this.minuteHandStyles(),{transform: [{ rotate: this.state.min + "deg" },{translateY: -(this.props.minuteHandOffset +this.props.minuteHandLength / 2)}]}]}/> */}
           {this.props.hourFormate === 12 && <View style={[this.secondHandStyles(),{transform: [{ rotate: this.state.sec + "deg" },{translateY: -(this.props.secondHandOffset +this.props.secondHandLength / 2)}]}]}/>}
          {/* <View style={[this.secondHandStyles(),{transform: [{ rotate: this.state.sec + "deg" },{translateY: -(this.props.secondHandOffset +this.props.secondHandLength / 2)}]}]}/> */}
