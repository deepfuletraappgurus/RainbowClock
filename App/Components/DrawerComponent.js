...
export default class DrawerContainer extends React.Component {
  ...
  onPressMenuItem(strMenuItem) {
    if (strMenuItem.title == 'Logout') {
      ...
      this.state.objSelectedChild <= 0 &&
      strMenuItem.title == 'Change User'
    ) {
  ...
  render() {
    return (
      <ImageBackground
        source={this.state.isMenuAsParentPortal ? Images.aside1 : Images.aside}
              ...
              <FlatList
                ...
                data={
                  this.state.isMenuAsParentPortal
                    ? Constants.ARR_PARENT_PORTAL_DRAWER
                    : Constants.ARR_DRAWER
                }
